...
namespace SignalManipulator.UI.Controls.Components.Sliders.Precision
{
    ...
    public class PrecisionSlider : PrecisionControl
    {
        ...
        {
            trackBar.Minimum = ScaleMapper.ToControlUnits(ScaleMapper.RealMin);
            trackBar.Maximum = ScaleMapper.ToControlUnits(ScaleMapper.RealMax);
        }
    }
}